...
package com.pengjunwei.mvp.manager;
...
class ActivityScopedCache {
    ...
    */
    ...
    /**
     * Get the Presenter for a given {@link com.pengjunwei.mvp.IView2} if exists or <code>null</code>
     *
     * @param viewId The mosby internal view id
     * @param <P>    The type tof the {@link com.pengjunwei.mvp.IPresenter2}
    ...
    /**
     * Get the ViewState for a given {@link com.pengjunwei.mvp.IView2} if exists or <code>null</code>
     *
     * @param viewId The mosby internal view id
     * @param <VS>   The type tof the {@link IPresenter2}
     ...
     *
     * @param viewId    The mosby internal View id of the {@link IView2} which the presenter is
     *                  associated to.
     * @param presenter The Presenter
     */
    public void putPresenter(@NonNull String viewId,
                             @NonNull IPresenter2<? extends IView2> presenter) {
